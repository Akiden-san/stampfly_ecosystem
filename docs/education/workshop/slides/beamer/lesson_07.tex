...
\begin{frame}{ステップ応答 / Step Response}
  \begin{center}
    \resizebox{!}{0.78\textheight}{\input{../tikz/step_response}}
  \end{center}
\end{frame}

% ------------------------------------------------------------------
\begin{frame}{テレメトリ API}
  \begin{table}
    \centering
    \begin{tabular}{lll}
      \hline
      ...
      \hline
      \api{telemetry\_send(name, val)} & テレメトリ送信 & 名前, float 値 \\
...
float roll_target = roll_step;  // Ignore stick
