...
% ------------------------------------------------------------------
\begin{frame}[fragile]{作業フローの変更}
  \framesubtitle{このレッスンでは \texttt{sf lesson switch} は使いません}
...
\begin{frame}[fragile]{プロジェクト構成 / Project Structure}
  \framesubtitle{\texttt{sf app new my\_drone} が生成するファイル}
...
% ------------------------------------------------------------------
\begin{frame}[fragile]{ControlTask の中身}
  \framesubtitle{400\,Hz ループの処理フロー}
...
\begin{frame}[fragile]{実習: 全センサ Teleplot 可視化 / Hands-on}
  \framesubtitle{%
    編集ファイル: \texttt{firmware/my\_viz/main/main.cpp} の ControlTask 内}
  \begin{lstlisting}[style=sfcpp, basicstyle=\ttfamily\scriptsize]
