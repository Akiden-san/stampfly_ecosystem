...
\begin{frame}[fragile]{プロジェクト作成 / Create Project}
  {\small \texttt{sf app new} で vehicle と同じ環境を独自プロジェクトとして生成:}
...
\begin{frame}[fragile]{プロジェクト構成 / Project Structure}
  {\small \texttt{sf app new my\_drone} が生成するファイル:}
...
\begin{frame}[fragile]{実習: 全センサ Teleplot 可視化 / Hands-on}
  {\small 編集ファイル: \texttt{firmware/my\_viz/main/main.cpp} の ControlTask 内}
