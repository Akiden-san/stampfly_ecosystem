...
\begin{frame}{LED 状態遷移 / LED State Machine}
  \begin{center}
    \resizebox{0.95\linewidth}{!}{\input{../tikz/led_state_machine}}
  \end{center}
\end{frame}
...
\begin{frame}[fragile]{実習: ARM 状態で LED 色を変える / Hands-on}
  \begin{lstlisting}[style=sfcpp, title={user\_code.cpp}, basicstyle=\ttfamily\scriptsize]
#include "workshop_api.hpp"
void setup() {
    ws::print("Lesson 3: LED Control");
    ws::disable_led_task();  // Take over LED
    ws::set_channel(1);
}
void loop_400Hz(float dt) {
    if (ws::is_armed()) {
        ...
        ws::led_color(r, g, 0);  // Red=low, Green=full
    }
}
  \end{lstlisting}
\end{frame}
