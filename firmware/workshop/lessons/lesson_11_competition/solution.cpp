...
void setup()
{
    ws::print("Lesson 11: Competition - Reference solution");
}

void loop_400Hz(float dt)
{
    // This is the same as student.cpp - competition is about YOUR optimization!
    // student.cppと同じ内容 - コンペは自分で最適化するもの！
