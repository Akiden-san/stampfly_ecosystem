...
def _app_new(name: str) -> int:
    ...
    # Create symlink to workshop_api.hpp
    # workshop_api.hpp へのシンボリックリンクを作成
    main_dir = project_dir / "main"
    workshop_api = main_dir / "workshop_api.hpp"
    workshop_api_target = Path("../../workshop/main/workshop_api.hpp")
    os.symlink(workshop_api_target, workshop_api)
    console.print(f"  Linked workshop_api.hpp -> {workshop_api_target}")
